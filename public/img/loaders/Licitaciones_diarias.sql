...
--
-- Servidor: localhost
-- Tiempo de generación: 07-02-2016 a las 16:52:23
...
--
-- Base de datos: `licitaciones_diarias_04022016`
--
...
CREATE TABLE `Licitaciones_diarias` (
  ...
  `Fechainiciopregunta` datetime DEFAULT NULL,
  `Fechafinalpregunta` datetime DEFAULT NULL,
