...
<div class="row">
  <div class="col-md-12">
    <form action="{{ URL::to('especialidad/ingresar-especialidad') }}" method="post" class="form-horizontal">
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
      <div class="panel panel-default">
        <div class="panel-heading ui-draggable-handle">
          <div class="panel-title">
            <h3>Ingreso de Especialidades</h3>
          </div>
        ...
        <div class="panel-footer">
          <input type="submit" class="btn btn-success" value="Ingresar especialidad" />
        </div>
      </div>
    </form>
  </div>
